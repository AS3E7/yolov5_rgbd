...
#                         'detect_bbox_model_name': 'ZT_Depth_20200715', # 选择目标检测模型名称，【NewLG_OneClass_20200612】
...
#                         'detect_bbox_nms_thod': 0.5, # 目标检测目标框nms阈值
                         ...
                         'pt_cluster_num_thod': 60, # 超高聚类最少点云点数据
...
#                         'detect_bbox_pose_index': None, # 检测目标类别序号
                        ...
                        # 'detect_bbox_method_name': 'yolov3', # yolov3,ssd
                        # 'detect_bbox_model_name': 'LG_Depth_20201214', # LG model
                        # # 'detect_bbox_model_name': 'zt_c3_depth_07220600', # ZT model
                        # 'detect_bbox_input_image_size': 416, # 模型输入图像大小
                        # 'detect_bbox_score_thod': 0.6, # 目标检测目标框分数阈值
                        # 'detect_bbox_nms_thod': 0.5, # 目标检测目标框nms阈值
                         
                        # 'yolov3', zt-20210722
                        'detect_bbox_image_type': 'colormap_rgb', # 'rgb'/'colormap'
                          'detect_bbox_method_name': 'yolov3', # yolov3,ssd
                          'detect_bbox_model_name': 'zt_c3_rgbd_2branch_ch6_07221900', # 选择目标检测模型名称
                          'detect_bbox_input_image_size': 416, # 模型输入图像大小
                          'detect_bbox_score_thod': 0.5, # 目标检测目标框分数阈值
                          'detect_bbox_nms_thod': 0.5, # 目标检测目标框nms阈值
                         ...
                         'detect_bbox_use_bg_info': False, # 目标检测是否读取使用信息
                         'use_bg_info': True, # 是否读取背景信息
                         'use_bg_info_height_limit': 1.8, # 高度信息更细背景,eg: [Flase/0.5], 1.8
                         'use_bg_info_outlier_dist': 0.13, # 获取边界离群点距离阈值
                         'pt_cluster_num_thod': 50, # 超高聚类最少点云点数据
                         ...
                         'rgb2depth_foldername':r'detect_bbox\YOLO_Detect\data\RGB2DepthRotParams\ZT', # rgb2depth转换关系文件地址
