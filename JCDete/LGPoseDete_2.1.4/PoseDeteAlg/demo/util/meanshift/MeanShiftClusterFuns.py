...
if sys.platform == "win32": # windows
    CurLibMeanShiftDir = os.path.join(os.path.dirname(ThisFilePath), 'LibMeanShift.dll')
    LibMS = ctypes.CDLL(CurLibMeanShiftDir) 
else: # linux
    CurLibMeanShiftDir = os.path.join(os.path.dirname(ThisFilePath), 'MeanShift.dll')
    LibMS = ctypes.CDLL(CurLibMeanShiftDir) 
# Cluster Function
